...
<form action="?route=adminfilm" method="POST" enctype="multipart/form-data">
    ...
    <textarea name="acteur" id="acteur" cols="30"
        rows="10"><?php if (isset($_POST['acteur'])) {
            echo $_POST['acteur'];
        } ?></textarea>
    <label for="tmdb">Id Tmdb : </label>
    <input type="text" id="tmdb" name="tmdb" placeholder="A récuperer sur le site TMDB"
        value="<?php if (isset($_POST['tmdb'])) {
            echo $_POST['tmdb'];
        } ?>" required>
